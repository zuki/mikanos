...
void Window::DrawTo(FrameBuffer &dst, Vector2D<int> pos, const Rectangle<int> &area)
{
    if (!transparent_color_) {
        ...
        Rectangle<int> interscetion = area & window_area;
        dst.Copy(interscetion.pos, shadow_buffer_, {interscetion.pos - pos, interscetion.size});
        return;
    }
