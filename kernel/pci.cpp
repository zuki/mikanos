...
namespace {
    ...
    /** @brief devices[num_device]に情報を書き込み、num_deviceをインクルメントする */
    ...
    /** @brief 指定されたMSIケーパビリティを読み取る
     *
     * @param dev MSIケーパビリティを読み込むPCIデバイス
